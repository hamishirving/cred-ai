...
import { ArrowLeft, Play, Shield, Upload, Wrench, Zap, Loader2, CheckCircle2 } from "lucide-react";
...
export function SkillDetail({ skill }: SkillDetailProps) {
	...
	function handleSubmit(e: React.FormEvent) {
		...
		router.push(`/skills/${skill.id}/execute?${params.toString()}`);
	}
	...
	return (
		<>
			...
			<Card>
				<CardHeader className="pb-2">
					<CardTitle className="text-sm">Run Skill</CardTitle>
				</CardHeader>
				<CardContent>
			...
			<Card>
				<CardHeader className="pb-2">
					<CardTitle className="text-sm">Skill Prompt</CardTitle>
				</CardHeader>
				<CardContent>
