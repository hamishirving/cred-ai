...
const LoadingSkeleton = ({ artifactKind }: { artifactKind: ArtifactKind }) => (
	<div className="w-full">
		<div className="flex h-[57px] flex-row items-center justify-between gap-2 rounded-t-2xl border border-b-0 p-4 dark:bg-muted">
...
const PureDocumentHeader = ({
	...
	<div className="flex flex-row items-start justify-between gap-2 rounded-t-2xl border border-b-0 p-4 sm:items-center dark:bg-muted">
...
const DocumentContent = ({ document }: { document: Document }) => {
	...
	const containerClassName = cn(
		"h-[257px] overflow-y-scroll rounded-b-2xl border border-t-0 dark:bg-muted",
		{
