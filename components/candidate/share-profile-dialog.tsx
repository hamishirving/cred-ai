...
export function ShareProfileDialog({ profileId }: { profileId: string }) {
	...
	return (
		...
		>
			...
			<DialogContent className="w-[calc(100vw-2rem)] max-w-2xl overflow-hidden border-border bg-background p-0">
				...
				<DialogHeader>
					<DialogTitle className="text-foreground">Share candidate profile</DialogTitle>
				...
				<div className="space-y-3">
					<div className="rounded-md border border-border bg-muted p-3">
						<p className="mb-2 text-xs uppercase tracking-wide text-muted-foreground">Link expiry</p>
