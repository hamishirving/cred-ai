...
export function CallResultsSheet({
	...
	// Extract structured outputs - matching voice-ai pattern
	...
	const comparisonRows = [
		...
		},
		{
			...
			original: "-",
			confirmed: formatValue(confirmedData.eligible_for_rehire),
			matchFunction: () => false,
		},
	].filter((row) => row.confirmed && row.confirmed !== "-");
	...
	return (
		<Sheet open={open} onOpenChange={onOpenChange}>
			<SheetContent className="w-full sm:max-w-2xl overflow-y-auto z-[60]">
								...
								<div className="mt-4">
									<Button
										...
										onClick={() => {
											...
											a.href = url;
											a.download = `${candidateName.replace(/\s+/g, "_")}_transcript.txt`;
											a.click();
