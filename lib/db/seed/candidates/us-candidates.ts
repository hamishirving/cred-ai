...
export const travelNurseCandidates: CandidateProfile[] = [
	...
	// Scenario 1: New clinician — first FL placement, partial compliance
	{
		...
		state: {
			...
			daysSinceActivity: 1,
			notes: "New travel ICU RN. First Florida placement. Has compact license, BLS, ACLS, PALS from Tennessee assignment. Health records and background screening still needed. Standard deal — Package #1, no OIG/SAM.",
		},
	},
