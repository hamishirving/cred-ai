/**
 * BLS Certificate Verification Agent
 *
...
export const blsVerificationAgent: AgentDefinition = {
...
If NOT a BLS/ACLS/PALS certificate from the American Heart Association, STOP and report the result. This agent only handles AHA certificates.
